!(function(a) {
      ...
      const n = a.substr(m).replace(/^-*/, ""),
        t =
          ...
          (function(a) {
            ...
            if (!i) return;
            const { hostname: n } = i;
            return n.includes(".") && s.a(n) && (!e.d(n) || o.includes(n))
              ? i.href
              : void 0;
          })(n);
      if (t) return r + t;
      ...
      return {
        attr: function(a, i, ...e) {
          ...
          e.forEach(e => {
            ...
            if ((o(i, t, e.onget, e.onset), "innerText" === t))
              return void (c[a] = e);
            m[a]
              ? (m[a].push(e), (n = !0))
              : ((m[a] = [e]), (p[a] = {}), (l[a] = {})),
            ...
            !n &&
              ...
              r(
                ...
                a =>
                  function(o) {
                    return (
                      console.warn("setAttributeNode:", o, this),
                      t(a, this, arguments)
                    );
                  }
              ));
  ...
  function(a, o, i) {
    ...
    function p(a, o, i) {
      ...
      if (
        (s(e, i) && (e.isExpired = !0),
        e.name.startsWith("__Secure-") &&
          ("https:" !== o.protocol || !e.secure))
      )
        return;
      if (
      ...
      const u = o.hostname;
      if (e.domain) {
        if (((m = e.domain), (c = u) !== m && !c.endsWith("." + m)))
          return void console.warn(
            "[jsproxy] invalid cookie domain! `%s` ⊄ `%s`",
            e.domain,
            u
          );
      ...
      if (e.path) {
        if (!t(e.path, p))
          return void console.warn(
            "[jsproxy] invalid cookie path! `%s` ⊄ `%s`",
            e.path,
            p
          );
      } else e.path = p;
      return (
        (e.id = (e.secure ? ";" : "") + e.name + ";" + e.domain + e.path), e
      );
    }
    function l(a) {
      const o = a.id,
    ...
    async function h(a) {
      ...
      await g.enum(
        "cookie",
        a => (s(a, o) ? g.delete("cookie", a.id) : l(a), !0)
      ),
        setInterval(d, 3e3);
    }
    async function d() {
      ...
      for (const o of a)
        o.isExpired
          ? await g.delete("cookie", o.id)
          : isNaN(o.expires) || (await g.put("cookie", o));
    }
  },
  function(a, o, i) {
    "use strict";
  ...
  function(a, o, i) {
    ...
    function n(a) {
      ...
      return (
        (a = (a = a.replace(
          /(\b)location(\b)/g,
          (a, i, e) => ((o = !0), i + "__location" + e)
        )).replace(
          /postMessage\s*\(/g,
          a => ((o = !0), a + "...(self.__set_srcWin?__set_srcWin():[]), ")
        )),
        o ? a : null
      );
    }
    ...
    function h(a, o, i) {
      ...
      const c = new Proxy(e, {
        ...
        set(a, i, e) {
          if (!(i in t))
            return (
              console.log("[jsproxy] %s set: %s = %s", o, i, e), r(i, e), !0
            );
          t[i] = e;
        },
        deleteProperty: (a, i) => (
          console.log("[jsproxy] %s del: %s", o, i), u(i), !0
        ),
        has: (a, e) => (
          console.log("[jsproxy] %s has: %s", o, e),
    ...
    function b(a, o) {
      !(function(a, o) {
        ...
        function m(a) {
          return function(o) {
            return (
              arguments.length > 0 && (arguments[0] = i + o),
              c(a, this, arguments)
            );
          };
        }
            ...
            a =>
              async function() {
                const o = await c(a, this, arguments),
                  i = [];
                for (const a of o)
                  "." !== a.name[0] && ((a.name = t(a.name)), i.push(a));
                return i;
              }
          ),
      ...
      !(function(a) {
        ...
        const t = {
            ...
            replace(a) {
              return (
                a &&
                  (console.warn("[jsproxy] location.replace:", a),
            ...
            assign(a) {
              return (
                a &&
                  (console.warn("[jsproxy] location.assign:", a),
                  (arguments[0] = e.i(a, this))),
                o.assign(...arguments)
              );
            }
        ...
        s.c(
          ...
          a =>
            function(i) {
              return (
                i &&
                  (console.log("[jsproxy] new %s: %s", o, i),
  ...
  function(a, o, i) {
    ...
    function g(a) {
      ...
      const { location: h, navigator: d } = a,
        j = new URL(o.baseURI),
        b = r.b(a);
      c.d(a, { loc: h, doc: o, ori: j, domHook: b }),
        p.init(a, j.origin),
        k(a, b);
              ...
              if (r && n) {
                ...
                if (a) {
                  ...
                  if (e.origin !== a.origin)
                    throw Error(
                      `Failed to execute '${o}' on 'History': A history state object with URL '${n}' cannot be created in a document with origin '${
                        e.origin
                      }' and URL '${i}'.`
                    );
                  arguments[2] = s.g(a);
        ...
        O,
        {
          ...
          onset(a) {
            ...
            switch (a.toLowerCase()) {
              case "refresh":
                (o = s.l(this.content, this)) !== a &&
                  (console.warn("[jsproxy] meta redir"), (this.content = o));
                break;
      ...
      "http:" === j.protocol && (M("SCRIPT", A, "src"), M("LINK", N, "href")),
      ...
      function F(a, o) {
        const i = a.type;
        console.log("update script src:", a.src);
  ...
  function(a, o, i) {
      ...
      try {
        return await (async function(a, o) {
          ...
          const n = await e.arrayBuffer(),
            ...
            l = t.subarray(2 + r);
          return (
            (p.date = new Date().toUTCString()), new Response(l, { headers: p })
          );
        })(a, o);
      } catch (a) {
    ...
    async function E(a, o, i, e) {
      await v.put("url-cache", { url: a, host: o, info: i, expires: e });
    }
    ...
    async function M(a, o, i) {
        ...
        return (
          o.forEach((a, o) => {
            if (
              ...
              "access-control-expose-headers" === o
            )
              return;
      ...
      if (P) {
        const a = t.l(P, c);
        a !== P &&
          (console.log("[jsproxy] http refresh:", P), S.set("refresh", a));
      }
      let T;
      if (M.length) {
          ...
          if (!t) {
            ...
            a.enqueue(n),
              (await (function(a) {
                ...
                console.warn(
                  "[jsproxy] page wait timeout. id: %d url: %s",
                  o,
                  i.href
                );
          }
    ...
    async function Q(a, o, i) {
      const e = await B.matchAll({ type: "window" });
      for (const n of e)
    ...
    async function aa(a, o, i, e) {
      ...
      if ("script" === b || "worker" === b || "sharedworker" === b) {
          if (
            o.host == "cdn.bootcss.com"
          ) {
            return (
              l("content-type", "text/javascript"),
      ...
      return "navigate" === a.mode && "text/html" === d
        ? Y(r, g, o)
        : new Response(r.body, g);
    }
    async function oa(a, o) {
      ...
      try {
        ...
        return (
          console.error(a), X("前端脚本错误<br><pre>" + a.stack + "</pre>", 500)
        );
      }
    }
    let ia, ea;
    ...
    function ta(a, o) {
      if (!o && I) {
        ...
        a.node_map[I.node_default]
          ? (a.node_default = I.node_default)
          : console.warn(
              "default node %s -> %s",
              I.node_default,
              a.node_default
      ...
      a.respondWith(
        (async function(a) {
          ...
          if (i === e.g || i === e.d) {
            ...
            return (
              I.index_path || (a = I.assets_cdn + "index_v3.html"),
